...
function ShowOutputsModal() {
    ...
    require([
        "jquery", '/static/app/Splunk_Security_Essentials/components/controls/Modal.js'
    ], function($, Modal) {
...
function triggerDocsRead(id) {
    ...
    if (typeof localStorage["sse-docs-" + id] == "undefined" || localStorage["sse-docs-" + id] != "complete") {
        buttonText = '<img style="height: 1.2em; width: 1.2em;" src="/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif" /> Section Completed'
        $("#docsButton-" + id).html(buttonText)
        // console.log("Running it", buttonText)
        localStorage["sse-docs-" + id] = "complete"
        navCheckmark = '<img style="height: 1em; width: 1em;" src="/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif" />&nbsp;'
                ...
                _.each(categories, function(category) {
                    ...
                    categoryFiltered.forEach(function(exampleInfo) {
                        ...
                        if (typeof localStorage["sse-docs-" + id] == "undefined" || localStorage["sse-docs-" + id] != "complete") {
                            ...
                            buttonText = '&nbsp;&nbsp;<button style="btn" id="docsButton-' + id + '" onclick=\'triggerDocsRead("' + id + '")\' ><img style="height: 1.2em; width: 1.2em;" src="/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif" /> Section Completed</button>'
                            navCheckmark = '<img style="height: 1em; width: 1em;" src="/static/app/Splunk_Security_Essentials/images/general_images/ok_ico.gif" />&nbsp;'
                        }
                        ...
                        var $exampleDescription = $('<div></div>').addClass("documentation").html(exampleInfo['short-description'].replace(/\%SSEDOCIMAGEPATH\%/g, "/static/app/Splunk_Security_Essentials/images/docimages"));
